    ...
    height: 100vh;">
        ...
        <div class="header-box">
            ...
            <div class="info-page-header">
                <a href="../TaoKPI 4/taokpi4.php" style="text-decoration: none;">
                    <span>
                        <i class="fa-solid fa-chevron-left" style="color:  #2260FF;"></i>
                    </span>
                </a>
                
                <span class="page-name">THÊM NHIỆM VỤ</span>
            </div>
            </div>
        </div>
        ...
        <div class="content-top-box">
            <div class="content-top-month">
                THÁNG SÁU <i class="fa-solid fa-chevron-down" style="text-align: center;"></i></div>
        ...
        <div class="content-bot-parent">
            ...
            <div class="btn-row">
              <div class="btn2 mt-3  "  ><a href="../TaoKPI 5/taokpi5.php" style="text-decoration: none; color:white">XÁC NHẬN</a></div></div>
             </div>
        </div>
