...
<body>
    <div class="container-fluid" style="padding: 0px;">
        ...
        <div class="header-box">
            ...
            <span class="hello1">Chào bạn,
                <br>
                <span class="hello2">Vinh Nguyễn</span>
            </span>
        ...
        <div class="content-top-box">
            ...
            <div class="content-top-task-box">
                <div style="color: #2260FF;
                ...
                margin-top: 10px;
                margin-left: 20px;
                padding-left: 90px;">Thứ 4, 11/02/2024 - Hôm nay
                </div>
                <div class="content-top-time-box ">
                    <span class="" style="color: #2260FF;">09:00</span>
                    <span class="time-none"></span>
                </div>
                <div class="content-top-time-box " style="margin-top: 20px;margin-bottom: 20px; margin-left: 10px;"><span>
                    <div class="" style="color: #2260FF; margin-top: 10px;">10:00</div>
                    <div class="" style="color: #2260FF;  margin-bottom: 10px; ">11:00</div>
                </span>
                    
                    <span class=" content-top-task-parent">
                        <div class="task-name-row" >
                            <div class="row">
                                <!-- <div class="col-1"></div> -->
                                <div class="col-8" style="color: #2260FF;
                                ...
                                font-weight: 500;
                                line-height: normal;
                                margin-left: 10px;">Học tiếng Nhật bài 5</div>
                                 <div class="col-1" >
                                    <div style=" width: 12px;height: 12px;border-radius: 5px;
                                background-color: #fff; display: flex;justify-content: center;align-items: center; font-size: 12px;">
                        ...
                        <div class="row">
                            <!-- <div class="col-1"></div> -->
                            <div class="col-8" style="margin-right: 20px;">10:00-11:00</div>
                            <div class="col"></div>
                        </div>
                    </span>
                </div>
                ...
                <div class="content-top-time-box ">
                    <span class="" style="color: #2260FF;">12:00</span>
                    <span class=" time-none" ></span>
                </div>
            </div>
        </div>
        ...
        <div class="content-bot-parent">
            <div class="content-bot-box overflow-auto" > 
                <a href="../ThongTinNhiemVu/nhiemvu.php" style="text-decoration: none;">
                    <div class="content-bot-item-box">
                        <div class="content-bot-item-box2">
                            <div class="content-item-name">Phát triển Website</div>
                        <div class="content-item-time">10:00-11:00</div>
                    </div>
                    </div>
                </a>
                <div class="content-bot-item-box">
                    <div class="content-bot-item-box2">
                        <div class="content-item-name">Học ITSS bài 3</div>
                        <div class="content-item-time">10:00-11:00</div>
                   </div>
                </div>
                <div class="content-bot-item-box">
                    <div class="content-bot-item-box2">
                    <div class="content-item-name">Học UIUX chương 4</div>
                    <div class="content-item-time">10:00-11:00</div>
                   </div>
                </div>
                <div class="content-bot-item-box">
                    <div class="content-bot-item-box2">
                    <div class="content-item-name">Học Machine Learning</div>
                    <div class="content-item-time">16:00-17:00</div>
                   </div>
                </div>
                <div class="content-bot-item-box">
                    <div class="content-bot-item-box2">
                    <div class="content-item-name">Tập thể dục</div>
                    <div class="content-item-time">17:00-18:00</div>
                   </div>
                </div>
                <div class="content-bot-item-box">
                    <div class="content-bot-item-box2">
                    <div class="content-item-name">Học Deep Learning</div>
                    <div class="content-item-time">10:00-11:00</div>
                   </div>
                </div>
        ...
        <div class="footer-parent">
            <div class="footer-box">
                <span><img src="./assets/img/home.svg" alt=""></span>
                <span><a href="../TaoKPIFN/taokpi1fn.php"><img src="./assets/img/add_black.svg" alt=""></a></span>
                <span><img src="./assets/img/list.svg" alt="" style="width: 30px;height: 30px;"></span>
                <span><img src="./assets/img/chart.svg" alt="" style="width: 28px;height: 28px;"></span>
            </div>
        </div>
    </div>
